...
public class MainActivity extends Activity {
    ...
    private com.example.android.SimpleCalc.Calculator mCalculator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCalculator = new com.example.android.SimpleCalc.Calculator();
    ...
    public void onAdd(View view) {
        compute(com.example.android.SimpleCalc.Calculator.Operator.ADD);
    }
    ...
    public void onSub(View view) {
        compute(com.example.android.SimpleCalc.Calculator.Operator.SUB);
    }
    ...
    public void onDiv(View view) {
        try {
            compute(com.example.android.SimpleCalc.Calculator.Operator.DIV);
    ...
    public void onMul(View view) {
        compute(com.example.android.SimpleCalc.Calculator.Operator.MUL);
    }

    private void compute(com.example.android.SimpleCalc.Calculator.Operator operator) {
        double operandOne;
        double operandTwo;
        try {
